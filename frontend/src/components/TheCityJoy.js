...
import hidden from "../assets/hiddengems.webp";
        ...
        <Container className="py-5">
          ...
          <Col xs={12} sm={6} md={3} lg={3}>
              <Link to="/topplaces">
                ...
                >
                  <Card.Img variant="top" src={kolkatashop} alt="Card 1" />
                  <Card.Body>
                    {/* <Card.Title></Card.Title> */}
                    <Card.Text className="py-1" style={{ color: "teal" }}>
                    Kolkata, a city of myriad colors, offers shopaholics a .....
                    </Card.Text>
                  </Card.Body>
                </Card>
              </Link>
            ...
            <Col xs={12} sm={6} md={3} lg={3}>
              <Link to="/gems">
                ...
                >
                  <Card.Img variant="top" src={hidden} alt="Card 1" style={{height:"200px"}}/>
                  <Card.Body>
                    {/* <Card.Title></Card.Title> */}
                    <Card.Text className="py-1" style={{ color: "teal" }}>
                    Kolkata, the cultural capital of India, is known .....
                    </Card.Text>
                  </Card.Body>
                </Card>
              </Link>
